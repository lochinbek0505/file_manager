...
import uz.falconmobile.filemanager.databinding.ActivityMainBinding
...
//        }
        ...
        binding.btnInternal.setOnClickListener {
            ...
            startActivity(Intent(this@MainActivity, ShowFIlesActivity::class.java))
...
////            }
//        startActivity(Intent(this, ShowFIlesActivity::class.java))
//        }
...
//    }
    ...
    private fun displayStorageInfo() {
        ...
        val availableStorageTextView2 = findViewById<TextView>(R.id.storageInfoTextView2)
        ...
        availableStorageTextView2.text = "$availableSpaceGB GB free of $totalSpaceGB GB"
